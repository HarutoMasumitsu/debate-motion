    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <div className="flex-1 max-w-4xl mx-auto px-4 md:px-8 py-8">
          ...
          {/* Rich text editor (inline WYSIWYG) */}
          <RichEditor
            value={content}
            onChange={setContent}
            placeholder="本文を入力...\n\n「##」で見出し、「-」で箇条書き、「>」で引用"
        ...
        <div className="hidden lg:block w-72 border-l border-border p-4 space-y-4 shrink-0 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto">
          ...
          {/* Shortcut guide */}
          <div className="bg-card rounded-lg border border-border p-4">
            <h3 className="text-sm font-medium mb-3">ショートカット</h3>
            <div className="text-xs text-muted-foreground space-y-1.5">
              <p><code className="bg-muted px-1 py-0.5 rounded">Ctrl+B</code> → 太字</p>
              <p><code className="bg-muted px-1 py-0.5 rounded">Ctrl+I</code> → 斜体</p>
              <p><code className="bg-muted px-1 py-0.5 rounded">## スペース</code> → 見出し2</p>
              <p><code className="bg-muted px-1 py-0.5 rounded">### スペース</code> → 見出し3</p>
              <p><code className="bg-muted px-1 py-0.5 rounded">- スペース</code> → 箇条書き</p>
              <p><code className="bg-muted px-1 py-0.5 rounded">1. スペース</code> → 番号付き</p>
              <p><code className="bg-muted px-1 py-0.5 rounded">&gt; スペース</code> → 引用</p>
              <p><code className="bg-muted px-1 py-0.5 rounded">Tab</code> → リストをネスト</p>
            </div>
          </div>
